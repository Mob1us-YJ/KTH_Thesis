...
path = 'quick_results/results_LeNet.npz'
...
ax.set_ylabel('Loss')
ax.set_title('Self-supervised losses (LeNet/CNN)')
...
ax2.set_title('Supervised training (LeNet/CNN)')
ax2.grid(True, alpha=0.2)

out = 'quick_results/results_LeNet_plots.png'
plt.tight_layout()
